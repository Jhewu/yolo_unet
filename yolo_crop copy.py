...
def crop_from_yolo(image_results, image_paths, label_split_dir, image_dest_dir, label_dest_dir, verifier_dest): 
    ### Crop image using bounding boxes and create yolo_cropped/ and verifier_dataset/ datasets

    global TOTAL_PREDICTIONS

    print(f"\nThis is the len of results {image_results}")
...
def yolo_crop_async(): 
    ...
    for split in ["test", "train", "val"]:
        ...
        verifier_dest_split = os.path.join(VERIFIER_DEST, split)
        ...
        #     crop_from_yolo(image_results, image_path, label_split, image_dest_split, label_dest_split, verifier_dest_split)
